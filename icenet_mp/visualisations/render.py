...
def _suppress_mpl_animation_logs() -> Generator[None]:
...
def _image_from_figure(fig: Figure, *, dpi: int) -> ImageFile:
...
def render_panels_static(  # noqa: PLR0913
    ...
    *,
    ...
    try:
        return _image_from_figure(figure, dpi=dpi)
    finally:
        plt.close(figure)
...
def render_panels_video(  # noqa: PLR0913
    ...
    *,
    ...
    try:
        ...
        return _video_from_animation(anim, dpi=dpi, fps=fps, video_format=video_format)
    finally:
        plt.close(figure)
